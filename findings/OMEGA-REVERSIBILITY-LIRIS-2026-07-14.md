...
**Metatagging particles for a simulated universe** — verification of the v3 orientation-orbit layer (C2^3 orbit + antiparticle + Ω): the R/N/Q rules are provably involutive/reversible and the Ω commitment holds byte-exact.
